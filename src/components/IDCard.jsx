...
const IDCard = () => {
  ...
  return (
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md h-[420px] sm:h-[480px] md:h-[520px] rounded-2xl overflow-hidden bg-[#181818] shadow-xl border border-[#222] mx-auto">
